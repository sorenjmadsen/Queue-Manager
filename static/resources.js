            ...
            for (const lab of Object.values(body.resources)) {
                for (const resource of lab) {
                    ...
                    if(resource.resource.lab==1){
                        li.textContent = JSON.stringify(resource.resource.author) + JSON.stringify(resource.resource.files) + JSON.stringify(resource.resource.text) + " Date and Time Submitted: " + JSON.stringify(resource.resource.date)
